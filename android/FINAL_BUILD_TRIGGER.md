# ZoneProspect 360 — final Google Play bundle build
...
The generated release AAB must be signed with the existing ZoneProspect 360 upload key; no replacement upload key is permitted.
