(()=>{
  ...
  function kit(o){return '<div class="sd-prospect-title">🚀 Plan d’action commercial</div><div class="sd-prospect-grid">'+
    ...
    '<div class="sd-prospect-actions"><button type="button" data-sd-add-pipeline="'+esc(o.id)+'">+ Ajouter au pipeline</button></div>'}
  ...
  document.addEventListener('click',e=>{const b=e.target.closest('[data-sd-add-pipeline]');if(!b)return;const id=b.getAttribute('data-sd-add-pipeline');if(id&&typeof window.addPipeline==='function')window.addPipeline(id)});
